...
export class PerformanceCounterMetrics {
    ...
    constructor(config, options) {
        ...
        // Create Instruments
        this._requestDurationHistogram = this._meter.createHistogram(PerformanceCounterMetricNames.REQUEST_DURATION, { valueType: ValueType.DOUBLE });
        ...
        this._memoryPrivateBytesGauge = this._meter.createObservableGauge(PerformanceCounterMetricNames.PRIVATE_BYTES, { description: "Amount of memory process has used in bytes", valueType: ValueType.INT });
        this._memoryAvailableBytesGauge = this._meter.createObservableGauge(PerformanceCounterMetricNames.AVAILABLE_BYTES, { description: "Amount of available memory in bytes", valueType: ValueType.INT });
